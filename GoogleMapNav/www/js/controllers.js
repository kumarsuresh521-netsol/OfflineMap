...
.controller('Map3Ctrl', function($scope) {
    ...
    function drawRoute_old(destination){ console.log(destination);
    ...
    function drawRoute(start, destination){
       ...
       // Other offers... 
        ...
        console.log(start); console.log(destination);
        var sevt = start;
     ...
     function startNavigation(start, destination, route){ alert("duck");
           ...
           function geo_error() {
            ...
            function onSuccess(position){ //alert("11");
                        var pos = {
                                lat: position.coords.latitude,
                                lng: position.coords.longitude
                              };
                            ...
                            marker.setMap(null); //alert("12");
                            marker = new google.maps.Marker({
                                position: pos,
                                title: "My Current Location",
                                icon: 'img/nav3.png',
                            }); //alert("13");
                            marker.setMap(map); //alert("14");
                            map.setCenter(pos); //alert("15");
                            
                            
                            troute = route.legs[0].steps[ddd1];console.log(troute); //alert("16");
                  
                              var distance212 = google.maps.geometry.spherical.computeDistanceBetween(pos, troute.end_location);
                  ...
                  //console.log(distance212); alert(distance212);
                   ...
                   if(distance212 <= 200 && ddl <= ddd1){
                    ...
                    if(distance212 <= 50){
                        ddl = 0;
                        var distanceeee = angular.element( document.querySelector( '#distanceeee' ) );
                        distanceeee.html(route.legs[0].steps[ddd1].instructions);
                    } else {
                        var distanceeee = angular.element( document.querySelector( '#distanceeee' ) );
                        distanceeee.html("Remaining distance "+distance212+"<br/>"+route.legs[0].steps[ddd1].instructions);
                    }
     ...
     // var abc = poi.split(',');
      ...
      for(i=0; i < abc.length; i++){
        ...
        */
            ...
            } else if(poi == 'resturant, hospital, atm'){
                var image = "img/store_32x32.png";
            } else if(poi == 'atm'){
                var image = "img/atm_32x32.png";
